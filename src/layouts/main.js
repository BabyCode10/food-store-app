    ...
    <div className="h-screen min-h-screen flex overflow-hidden  bg-gray-100">
      <div className="flex-1 flex overflow-hidden divide-x divide-gray-400">
        <div className="w-1/6 flex flex-col">
          ...
          <button
            className="flex items-center text-red-400 pl-8 py-1 my-8"
      ...
      <Modal show={showLogout} onShow={() => setShowLogout(!showLogout)}>
        <div className="flex mb-8">
          ...
          <div>
            <h6 className="text-xl text-gray-800 mb-2">Ready to Leave?</h6>
